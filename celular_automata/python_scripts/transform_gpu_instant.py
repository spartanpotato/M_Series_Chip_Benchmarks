...
input_file = f'./outputs/csvs/{storageType}Storage_instant.csv'  # Replace with your actual input file
output_file = f'./outputs/csvs/{storageType}Storage_instant_transformed.csv'  # Replace with your desired output file
...
with open(input_file, 'r') as infile:
    ...
    for line in lines:
        ...
        power_match = re.match(r"GPU Power: (\d+) mW", line)
        if power_match:
