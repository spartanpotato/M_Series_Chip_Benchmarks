...
input_file = f'./outputs/csvs/{storageType}Storage_ot.csv'  # Replace with your actual input file
output_file = f'./outputs/csvs/{storageType}Storage_ot_transformed.csv'  # Replace with your desired output file
